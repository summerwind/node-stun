...
// Send UDP Packet
Client.prototype.send = function send(buffer, offset, length, cb) {
    this._client.send(buf, offset, length, this._port, this._host, cb);
};
...
Client.prototype.indicate = function indicate() {
